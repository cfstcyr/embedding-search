...
You must always provide the user with the source of the information. Source must always contains the document title and at least one section title of the document content.
